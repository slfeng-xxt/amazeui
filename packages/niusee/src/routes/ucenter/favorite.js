...
function Favorite({ location, dispatch, favorite, loading }) {
  let {
    curpath,
  } = favorite
  return (
    <div>
      ...
      <div className="content">
        <ul className="contert-main">
          ...
          <p className="contert-main-title">2017年5月19日</p>
          <li>
            <div className="media">
                <div className="media-left">
                  <a href="#">
...
export default connect(
  ({ favorite, loading}) => ({ favorite, loading: loading.models.favorite })
)(Favorite)

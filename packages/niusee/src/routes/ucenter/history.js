    ...
    <div>
      ...
      <div className="content">
        <ul className="contert-main">
          <p className="contert-main-title">今天</p>
          <li>
            <div className="media">
                ...
                <div className="media-body">
                  ...
                  <p className="clearfix"><span className="pull-left">已观看完</span></p>
                </div>
              </div>
          </li>
        </ul><ul className="contert-main">
          <p className="contert-main-title">更早</p>
          <li>
            <div className="media">
                <div className="media-left">
                  <a href="#">
                ...
                <div className="media-body">
                  <h5 className="media-heading">与学生深度沟通技</h5>
                  <p className="clearfix"><span className="pull-left">已观看至40%</span></p>
                </div>
              </div>
          </li>
        </ul>
...
export default connect(
  ({ history, loading}) => ({ history, loading: loading.models.history })
)(History)
